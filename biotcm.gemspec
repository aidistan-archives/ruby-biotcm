...
Gem::Specification.new do |s|
  ...
  s.description = 'BioTCM is designed as the base gem to build advanced applications on Bioinformatics.'
  s.license     = 'MIT'
  ...
  s.files         = FileList['lib/**/*', 'test/**/*', 'bm/**/*',
                             '.yardopts', 'rakefile', 'LICENSE', '*.md'].to_a
  s.require_paths = ['lib']
