...
class BioTCM::Databases::Medline
  ...
  #
  # # About E-utilities
  # [The Entrez Programming Utilities (E-utilities)](http://www.ncbi.nlm.nih.gov/books/NBK25500/) are a set of 
  # nine server-side programs that provide a stable interface into the 
