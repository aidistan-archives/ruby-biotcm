class BioTCM::Databases::Medline
  ...
  module EUtilities
    ...
    def esearch(params)
      BioTCM.curl('http://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi', params: params)
    end
    ...
    # @option params :webenv [String] web environment used
    def efetch(params)
      BioTCM.curl('http://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi', params: params)
    end
