...
describe BioTCM::Interfaces do
  describe BioTCM::Interfaces::Interface do
    ...
    it 'must render scripts' do
      assert(render_template(File.expand_path('../template.R.erb', __FILE__), { name: 'world' }))
    end
  end
  ...
  describe BioTCM::Interfaces::R do
    ...
    it 'must evaluate R scripts' do
      assert(evaluate_r_script(File.expand_path('../template.R.erb', __FILE__), { name: 'world' }))
    end
  end
  ...
  describe BioTCM::Interfaces::Matlab do
    ...
    it 'must evaluate MATLAB scripts' do
      assert(evaluate_matlab_script(File.expand_path('../template.m.erb', __FILE__), { name: 'world' }))
    end
  end
end
